...
class SummaryLearn extends StatelessWidget {
  const SummaryLearn({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Summary', style: AppTypography.title.copyWith(color: CustomColors.primaryPurple, fontSize: 25),),
        elevation: 0,
